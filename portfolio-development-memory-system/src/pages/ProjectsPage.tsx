        ...
        >
          <div style={{ marginBottom: '40px' }}>
            ...
            <p style={{ fontSize: '15px', color: 'var(--text-secondary)', maxWidth: '600px', lineHeight: 1.8 }}>
              Сайты, созданные с использованием искусственного интеллекта. Концепция универсальной системы для быстрого создания сайтов для малого бизнеса. (Включите VPN)
            </p>
          </div>
